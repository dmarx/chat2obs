...
if __name__ == "__main__":
    ...
    print(f"✅ Exchange has {len(result['exchanges'][0]['exchange'].messages)} messages")
    print(f"✅ Exchange has continuations: {result['exchanges'][0]['exchange'].has_continuations()}")
    
    # Show the exchange structure
    exchange = result['exchanges'][0]['exchange']
    print(f"✅ Exchange structure: {exchange}")
    print(f"✅ Exchange has {len(exchange.tags)} tags in its tags attribute")
    print(f"✅ Exchange UUID: {exchange.exchange_id}")
    print(f"✅ First message time: {exchange.first_message_time}")
    
    print("\n🎉 Improved exchange system working perfectly!")
