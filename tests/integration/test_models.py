...
class TestRawModels:
    ...
    def test_dialogue_messages_relationship(self, db_session):
        ...
        msg1 = Message(dialogue_id=dialogue.id, source_id='m1', role='user')
        msg2 = Message(dialogue_id=dialogue.id, source_id='m2', role='assistant')
...
class TestDerivedModels:
    """Tests for derived schema models."""
...
class TestCascadeDeletes:
    ...
    def test_delete_dialogue_cascades_to_messages(self, db_session):
        ...
        msg = Message(dialogue_id=dialogue.id, source_id='m1', role='user')
        db_session.add(msg)
        db_session.flush()
